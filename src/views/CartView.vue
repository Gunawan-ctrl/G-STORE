<template>
  ...
  <sub-header
    heading="#cart"
    subHeading="Tambahkan kode kupon Anda dan hemat hingga 70% untuk semua pembelian!"
  />
      ...
      <section v-if="cart.length">
        ...
        <div class="checkout-section">
          <div class="coupon">
            ...
            <form>
              <input type="text" placeholder="Masukkan kupon disini" />
              <action-button btnvalue="Gunakan" />
            </form>
          </div>
          <div class="checkout">
            <h3>Ringkasan</h3>
